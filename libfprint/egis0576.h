...
static const Egis0576Pkt EGIS0576_INIT_PACKETS[] = {
    ...
    {.len = 7,
     ...
     .res_len = 7},
    {.len = 9,
     .cmd = (unsigned char[]){0x45, 0x47, 0x49, 0x53, 0x63, 0x01, 0x02, 0x0f,
                              0x03},
     .res_len = 9},
    {.len = 7,
    ...
    {.len = 7,
     ...
     .res_len = 7},
    {.len = 13,
     .cmd = (unsigned char[]){0x45, 0x47, 0x49, 0x53, 0x63, 0x26, 0x06, 0x06,
                              0x60, 0x06, 0x05, 0x2f, 0x06},
     .res_len = 13},
    {.len = 7,
    ...
    {.len = 7,
     ...
     .res_len = 7},
    {.len = 18,
     .cmd = (unsigned char[]){0x45, 0x47, 0x49, 0x53, 0x63, 0x09, 0x0b, 0x83,
                              0x24, 0x00, 0x44, 0x0f, 0x08, 0x20, 0x20, 0x00,
                              0x00, 0x52},
     .res_len = 18},
    {.len = 13,
     .cmd = (unsigned char[]){0x45, 0x47, 0x49, 0x53, 0x63, 0x26, 0x06, 0x06,
    ...
    {.len = 7,
     ...
     .res_len = 7},
    {.len = 9,
     .cmd = (unsigned char[]){0x45, 0x47, 0x49, 0x53, 0x63, 0x2c, 0x02, 0x00,
                              0x57},
     .res_len = 9},
    {.len = 7,
